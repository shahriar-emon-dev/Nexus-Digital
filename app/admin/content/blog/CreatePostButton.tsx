...
export function CreatePostButton() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    // The blog/ prefix is applied rather than asked for: a post that lives
    // anywhere else is not a post.
    data.set("slug", `blog/${finalSlug}`);
    data.set("pageType", "post");
    data.set("templateId", "blog-post");
      ...
      <DialogContent>
        <form onSubmit={submit}>
          <DialogHeader>
            ...
            <DialogDescription>
              This creates a draft page with the post structure. Nothing is
          ...
          <DialogBody className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Input
                ...
                placeholder="What we learned shipping on the edge"
                autoFocus
                required
              />
            </div>
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-xs text-ink-tertiary">
                Will publish at{" "}
                <code className="font-mono">/blog/{finalSlug || "…"}</code>
              </p>
            </div>
          </DialogBody>
          <DialogFooter>
